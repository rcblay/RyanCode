...
sed -i "/format =/c\format = 'drive'; %available FORMATS = {'nmea', 'drive'}"  AnalysisRNXScript2.m
...
sed -i "/format =/c\format = 'nmea'; %available FORMATS = {'nmea', 'drive'}"  AnalysisRNXScript2.m
