function timingrnxBinaries_0_0bin = importWeek(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as column vectors.
%   TIMINGRNXBINARIES_0_0BIN = IMPORTFILE(FILENAME) Reads data from text
%   file FILENAME for the default selection.
%
%   TIMINGRNXBINARIES_0_0BIN = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads
%   data from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   timingrnxBinaries_0_0bin = importfile('results_0_0.txt',2, 9);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2016/06/24 11:47:52
...
timingrnxBinaries_0_0bin = dataArray{:, 1};
