...
%cd('/home/dma/Desktop/ARM_vs_x86')
%% Set File Details
% Set File String
fileStr = 'LrnxBinaries_0_0.bin';
% Set DateVector
dateVector = [0 0];
% Set Path for Plots and Files
parentpath = '/media/dma/30b7893e-d72b-48e3-9497-ebfdee07b0b31/DanielResults/output/StaticSim/';
plotpath = '/media/dma/30b7893e-d72b-48e3-9497-ebfdee07b0b31/DanielResults/output/StaticSim/Plots/';
